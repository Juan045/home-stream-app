...
-- serializados en `info`, tal como los devuelve media_analyzer: asi la tabla no
-- migra cada vez que SourceInfo gana un campo. Son columnas propias solo los
-- campos por los que el listado filtra u ordena.
